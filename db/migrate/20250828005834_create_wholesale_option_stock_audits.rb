class CreateWholesaleOptionStockAudits < ActiveRecord::Migration[7.2]
  def change
    create_table :wholesale_option_stock_audits do |t|
      t.references :wholesale_option, null: false, foreign_key: { to_table: :wholesale_options }
