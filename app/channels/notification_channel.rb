class NotificationChannel < ApplicationCable::Channel
  def subscribed
    Rails.logger.info("NotificationChannel subscription attempt - " + {
    ...
    if restaurant_id.present?
      ...
      begin
        ...
        Rails.logger.info("NotificationChannel subscription successful - " + {
        ...
        Rails.logger.error("NotificationChannel stream creation failed - " + {
          channel: channel_name,
          user_id: current_user.id,
          error: e.message,
      ...
      Rails.logger.error("NotificationChannel subscription rejected - " + {
  ...
  def unsubscribed
    Rails.logger.info("NotificationChannel unsubscribed - " + {
      user_id: current_user&.id,
      restaurant_id: restaurant_id,
      connection_id: connection.connection_identifier,
      subscription_id: identifier,
