...
class PaymentService
  ...
  def self.process_payment(restaurant, payment_method_nonce, order_id = nil)
    ...
    if payment_processor == "stripe"
      ...
      stripe_process_payment(restaurant, payment_method_nonce)
    else
