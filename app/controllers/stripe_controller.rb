class StripeController < ApplicationController
  ...
  def create_intent
    begin
      ...
      if result[:success]
        ...
        response_data[:payment_intent_id] = result[:payment_intent_id] if result[:payment_intent_id].present?
        response_data[:payment_method_types] = result[:payment_method_types] if result[:payment_method_types].present?
  ...
  def payment_intent
    ...
    result = tenant_stripe_service.retrieve_payment_intent(id)
    if result[:success]
